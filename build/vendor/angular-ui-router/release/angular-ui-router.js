...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory,           $locationProvider) {
   ...
   * </pre>
   *
   * @param {string} name A unique state name, e.g. "home", "search", "contacts".
   * To create a parent/child state use a dot, e.g. "search.sales", "home.newest".
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $location,   $urlRouter,   $browser) {
     ...
     * $state.includes("search"); // returns false
     * </pre>
     *
     * @description
     ...
     * @example
     * <pre>
     * expect($state.href("search.person", { person: "bob" })).toEqual("/search/bob");
     * </pre>
     *
 ...
 * following template:
 * <pre>
 * <a ui-sref="home">Home</a> | <a ui-sref="search">About</a>
 * 
 * <ul>
 ...
 * <pre>
 * <a href="#/home" ui-sref="home">Home</a> | <a href="#/search" ui-sref="search">About</a>
 * 
 * <ul>
 *     <li ng-repeat="contact in contacts">
